            ...
            <div class="d-flex flex-column gap-2">
                ...
                <div class="form-floating">
                    <textarea id="description" class="form-control" name="description" required autocomplete="description"
                        placeholder="Description" style="height: 100px;" disabled>{{ $product->description }}</textarea>
                ...
                <div class="form-floating">
                    <input id="quantity" type="number" class="form-control" name="quantity" required
                        autocomplete="quantity" placeholder="Quantity In Stock" value="{{ $product->quantity_in_stock }}"
                        disabled />
                ...
                <div class="form-floating">
                    <input id="category" type="text" class="form-control" name="category" required
                        autocomplete="category" placeholder="Category" value="{{ $product->category->name }}" disabled>
                ...
                <div class="form-floating">
                    <input id="created-at" type="text" class="form-control" name="created-at" required
                        ...
                        value="{{ $product->created_at->diffForHumans() }}" disabled />
                ...
                <div class="form-floating">
                    <input id="updated-at" type="text" class="form-control" name="updated-at" required
                        ...
                        value="{{ $product->updated_at->diffForHumans() }}" disabled />
