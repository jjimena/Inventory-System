            ...
            <div class="d-flex flex-column gap-2">
                ...
                <div class="form-floating">
                    <input id="product_id" type="number" step="any"
                        ...
                        autocomplete="product_id" autofocus placeholder="Product Id" value="{{ $orderItem->product_id }}"
                        disabled>
                ...
                <div class="form-floating">
                    <input id="order_id" type="number" step="any"
                        ...
                        autocomplete="order_id" autofocus placeholder="Order Id" value="{{ $orderItem->customer_id }}"
                        disabled>
                    <label for="order_id">Customers Id</label>
                ...
                {{-- User Id --}}
                {{-- <div class="form-floating">
            <input id="user_id" type="number" class="form-control" name="user_id" required autocomplete="user_id"
                placeholder="User Id" value="{{ $orderItem->user_id }}" disabled />
            <label for="user_id">User Id</label>
                ...
                <div class="form-floating">
                    <input id="unit_price" type="number" step="any"
                        ...
                        autocomplete="unit_price" autofocus placeholder="Unit Price" value="{{ $orderItem->unit_price }}"
                        disabled>
                ...
                <div class="form-floating">
                    <input id="created-at" type="text" class="form-control" name="created-at" required
                        autocomplete="created-at" placeholder="Created At"
                ...
                <div class="form-floating">
                    <input id="updated-at" type="text" class="form-control" name="updated-at" required
                        autocomplete="updated-at" placeholder="Updated At"
